...
#'
#' A miniature Seurat object containing spatial transcriptomics data.
#'
#'
#' @format A `Seurat` object containing spatial coordinates and expression data.
#' @source Downsampled from an in-house dataset
"my_spatial_data"
